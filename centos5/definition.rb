Veewee::Session.declare({
  ...
  :disk_size => '40520', :disk_format => 'VDI', :hostiocache => 'off', :ioapic => 'on', :pae => 'on',
  :os_type_id => 'RedHat_64',
  :iso_file => "CentOS-5.8-x86_64-bin-DVD-1of2.iso",
  :iso_src => "http://ftp.iij.ad.jp/pub/linux/centos/5.8/isos/x86_64/CentOS-5.8-x86_64-bin-DVD-1of2.iso",
